...
#	define DEV_SELECT  12	/* fcn code for select operation */
#	define SUSPEND	 -998	/* used in interrupts when tty has no data */

#define DP8390		(LANCE - ENABLE_DP8390)
#define LANCE		(SB16 - ENABLE_LANCE)
				/* networking task */
...
#define SELECT_ID      m6_i2	/* id for select timeout */
